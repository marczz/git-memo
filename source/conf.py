...
# -*- coding: utf-8 -*-
#
# Git Memo documentation build configuration file based on shinx 1.4.9
#
...
project = 'Git Memo'
copyright = '2012-2017, Marc Zonzon'
author = 'Marc Zonzon'
...
try:
    import subprocess
    commitdesc = subprocess.check_output(["git", "describe", "--tags", "--long"])
    commitdesc = commitdesc.decode().strip().split('-')
    # The short X.Y version.
    version = commitdesc[0]
    # The full version, including alpha/beta/rc tags.
    release = '-'.join(commitdesc[0:1])
    # not used by base sphinx
    commit =  commitdesc[2]
except subprocess.CalledProcessError:
    version = "alpha_not_set"
    release = version
    commit = ''
...
latex_documents = [
    (master_doc, 'GitMemo.tex', 'Git Memo Documentation',
     'Marc Zonzon', 'manual'),
]
...
man_pages = [
    (master_doc, 'gitmemo', 'Git Memo Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'GitMemo', 'Git Memo Documentation',
     author, 'GitMemo', 'One line description of project.',
     'Miscellaneous'),
]
