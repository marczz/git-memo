...
# -*- coding: utf-8 -*-
#
# Git Memo documentation build configuration file, created by
...
project = 'Git Memo'
copyright = '2012,2013 Marc Zonzon'
...
commit = Popen(["git", "log", "-1", "--pretty=%h", "--" , "."], stdout=PIPE).communicate()[0]
commit = commit.decode().rstrip('\n')
release = version+"_"+commit
...
latex_documents = [
  ('index', 'GitMemo.tex', 'Git Memo Documentation',
   'Marc Zonzon', 'manual'),
]
...
texinfo_documents = [
  ('index', 'GitMemo', 'Git Memo Documentation',
   'Marc Zonzon', 'GitMemo', 'One line description of project.',
   'Miscellaneous'),
]
